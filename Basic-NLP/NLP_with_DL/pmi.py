...
print("num_lines:", num_lines) # 4873334
print("num_tokens:", num_tokens) # 86500068
...
pmi_path = os.path.join(os.getcwd(), f'Basic-NLP/NLP_with_DL/w2v_model/pmi_counts_{V}.npz')
...
for epoch in range(10):
  ...
  loss = np.multiply(delta, delta).sum()
