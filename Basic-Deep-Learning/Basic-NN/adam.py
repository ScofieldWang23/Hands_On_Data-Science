...
def main():
    ...
    K = 10 # num of classes
    # the for params will be reused for RMSProp later
    ...
    # 1st moment, it should be a array of 0s, shape: M, K
    # but numpy knows how to automatically broadcast the scalar when adding to an array 
    mW1 = 0
    mb1 = 0
    mW2 = 0
    mb2 = 0
    ...
    # rmsprop cache, same as TensorFlow
    # here, we don't have bias correction!
    cache_W2 = 1
    cache_b2 = 1
    cache_W1 = 1
    cache_b1 = 1
    ...
    for i in range(max_iter):
        for j in range(n_batches):
            ...
            # adding the momentum would make the comparison more fair?
